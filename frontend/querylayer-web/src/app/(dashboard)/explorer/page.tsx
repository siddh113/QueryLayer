  ...
  return (
    <div className="fade-in max-w-2xl">
      <div className="mb-8">
        ...
        <p className="text-sm mt-2" style={{ color: 'var(--text-muted)' }}>Test and explore your API endpoints</p>
      </div>
      <div className="rounded-2xl glass-card p-10 text-center relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-48 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(255, 107, 74, 0.08), transparent)', filter: 'blur(40px)' }}
        />
